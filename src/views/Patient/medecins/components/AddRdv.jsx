...
const AjouterRDV = ({ closeModal , currentMedecin }) => {
    ...
    const [rdvData, setRdvData] = useState({ date: '', heureDebut: '', heureFin: '', statut: '' });
    ...
    const handleDateChange = (e) => {
        setRdvData({ ...rdvData, date: e.target.value });
    };

    const handleDebutChange = (e) => {
        setRdvData({ ...rdvData, heureDebut: e.target.value });
    };
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await ajouterRdv(rdv, token); // send the token
